...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 150, 280, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 860, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 280, 480, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 430, 380, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 340, 240, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 760, 440, 30, 15, 1)
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 130, 430, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieCaminante('imagenes/zombie3.png', 330, 630, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieCaminante('imagenes/zombie4.png', 280, 200, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieCaminante('imagenes/zombie2.png', 50, 330, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieCaminante('imagenes/zombie2.png', 400, 60, 10, 10, 1, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 8, { //vertical2
      desdeX: 0,
      hastaX: 961,
      desdeY: -15,
      hastaY: 600
...
Juego.dibujarMeta = function() {
  ...
  for(var i=758; i<880; (i+=20)) {
    Dibujante.dibujarRectangulo("darkturquoise",i, 535, 10,10);
    if(i<870) {
      Dibujante.dibujarRectangulo("darkturquoise",i+10, 545, 10,10);
    }
  }
}
